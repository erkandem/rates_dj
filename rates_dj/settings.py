"""
Django settings for rates_dj project.
...
MIDDLEWARE = [
    ...
    "whitenoise.middleware.WhiteNoiseMiddleware",  # routing static files in production
...
WSGI_APPLICATION = "rates_dj.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        "NAME": env.str("RATES_APP_POSTGRES_DATABASE"),
        "USER": env.str("RATES_APP_POSTGRES_USER"),
